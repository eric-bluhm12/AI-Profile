...
SUMMARY OPENING: The Summary must always begin with "Senior AI Engineer" (e.g. "Senior AI Engineer with X years..." or "Senior AI Engineer with more than 10 years...").
...
{"title":"<exact job title from JD only, no company>","summary":"<start with Senior AI Engineer; **bold** for tech terms; if 10+ years exp use only 'more than 10 years'>","skills":{"<CategoryName>":["skill1","skill2",...],...},"experience":[{"title":"<job title>","company":"<company name>","location":"<location or empty string>","start_date":"<start>","end_date":"<end>","details":["<bullet with **bold**>",...]}]}`;
    ...
    // Summary: must start with "Senior AI Engineer"
    if (typeof resumeContent.summary === "string" && !/^Senior AI Engineer/i.test(resumeContent.summary.trim())) {
      const s = resumeContent.summary.trim();
      const rest = s.charAt(0).toLowerCase() + s.slice(1);
      resumeContent.summary = "Senior AI Engineer " + rest;
    }
